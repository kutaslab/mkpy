...
Development of `dpath` seems to have slowed or stopped on
https://www.github.com/akesterson/dpath-python" as of 10/19

Rather than fork and release with patches, this is a snapshot
frozen because it works fine.


# Origin

Files in this directory were forked from the stale PR

https://github.com/akesterson/dpath-python/pull/85

from the repo

https://github.com/berend/dpath-python.git

branch `berend:feature/fix-importing-for-python38`


# Mods

* Stripped the packaging material, leaving a module with tests

* `import mock` -> `from unittest import mock` since `mock` is in
  standard lib since 3.3

* Tweaked classes Test* -> Tst* in test_types.py so pytest wouldn't
  try to test them


# For reference, `setup.py` and `README.rst`
...
We would like to thank the community for their interest and
involvement. You have all made this project significantly better than
the sum of its parts, and your continued feedback makes it better
