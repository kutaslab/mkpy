...
# -*- coding: utf-8 -*-
#
# mkpy documentation build configuration file, created by
...
sphinx_gallery_conf = {
    "examples_dirs": ["examples/mkh5", "examples/mkh5mne", "examples/mkh5eeglab"],
    "gallery_dirs": [
        "examples_gallery/mkh5",
        "examples_gallery/mkh5mne",
        "examples_gallery/mkh5eeglab",
    ],
...
exclude_patterns = ["_build", "Thumbs.db", ".DS_Store"]  # default
...
man_pages = [(master_doc, "mkpy", "mkpy Documentation", [author], 1)]
